...
@section('content')
    <div class="container">
        <div class="row justify-content-md-center">
            ...
            <img class="mb-3 img-fluid" src="../images/calendario adolescente.png"
                 alt="calendário de vacinação do adolescente">
            <img class="mb-3 img-fluid" src="../images/calendario adulto-idoso.png"
                 alt="calendário de vacinação do adulto e idoso">
            <img class="mb-3 img-fluid" src="../images/calendario gestante.png"
                 alt="calendário de vacinação da gestante">
            <img class="mb-3 img-fluid" src="../images/calendario viajante.png"
